            ...
            {path !== '/login' && path !== '/signup' && !path.startsWith('/verify') &&
                <div className='flex flex-row gap-3'>
                    ...
                    >
                        ...
                        className={`text-white ${isVerified ? "bg-green-800 dark:bg-green-700 cursor-default" : "bg-blue-700 hover:bg-blue-800 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 focus:ring-4 focus:outline-none "} font-medium rounded text-sm w-full sm:w-auto px-5 py-2.5 text-center `}
                        onClick={() => {
