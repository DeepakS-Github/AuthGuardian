...
const SignupPage = () => {
    ...
    return (
        <form className="w-11/12 sm:w-3/5 xl:w-1/4 absolute left-[50%] top-[50%] -translate-x-[50%] -translate-y-[50%] mx-auto shadow rounded p-6 bg-white dark:bg-gray-800" onSubmit={(e) => handleSignUp(e)}>
            <div className="mb-5">
